...
class RenderTargetSystem {
  ...
  clear(target, clear = _const.CLEAR.ALL, clearColor, mipLevel = this.mipLevel, layer = this.layer) {
    if (!clear) return;
    if (target) {
   ...
   */
  push(renderSurface, clear = _const.CLEAR.ALL, clearColor, frame, mipLevel = 0, layer = 0) {
