...
export declare abstract class RpgCommonMap<T extends RpgCommonPlayer> {
    ...
    data: import('@signe/reactive').WritableArraySignal<any>;
   ...
   */
     ...
     * ```
     */
    protected runFixedTicks(deltaMs: number, hooks?: {
        beforeStep?: () => void;
