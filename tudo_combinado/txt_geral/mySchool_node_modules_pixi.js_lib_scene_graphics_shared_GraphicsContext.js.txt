...
var getMaxMiterRatio = require('./utils/getMaxMiterRatio.js');
  ...
  texture(texture, tint, dx, dy, dw, dh) {
    this.instructions.push({
      ...
      data: {
        ...
        style: tint || tint === 0 ? Color.Color.shared.setValue(tint).toNumber() : 16777215
      }
    });
    this.onUpdate();
    return this;
    ...
    for (let i = 0; i < this.instructions.length; i++) {
      ...
      if (action === "stroke") {
        ...
        if (data.style.join === "miter") {
          outerPadding *= getMaxMiterRatio.getMaxMiterRatio(data.path, data.style.miterLimit);
        }
