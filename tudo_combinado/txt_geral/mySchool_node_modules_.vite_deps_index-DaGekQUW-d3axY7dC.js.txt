import { B as Bounds, P as BigPool, at as Point, dt as extensions, nt as Rectangle, ut as ExtensionType } from "./Geometry-Bst8trPt.js";
import { a as AbstractText, n as NineSliceSprite, o as TilingSprite } from "./lib-CKVJgzI9.js";
import { c as ViewContainer, l as Container } from "./Filter-zX_yb7DM.js";
import { m as Graphics } from "./CanvasRenderer-D_PDSKO5.js";
//#region node_modules/canvasengine/dist/index-DaGekQUW.js
var vg = (() => {
...
` + C.replace(/^Error(:[^\n]*)?\n/, ""));
		...
		function EI(g) {
			switch (g) {
				...
				case 4: return 2;
				case 8: return 3;
				default: throw new TypeError("Unknown type size: " + g);
			}
		}
		function AA(g, B, E = {}) {
		...
		function Rg(g, B) {
			...
			if (B.M || G("Cannot pass \"" + rI(B) + "\" as a " + this.name), B.M.O || G("Cannot pass deleted object as a pointer of type " + this.name), !this.ca && B.M.P.ca && G("Cannot convert argument of type " + (B.M.U ? B.M.U.name : B.M.P.name) + " to parameter type " + this.name), E = iI(B.M.O, B.M.P.N, this.N), this.da) switch (B.M.T === void 0 && G("Passing raw pointer to smart pointer is illegal"), this.Ba) {
				...
				case 2:
					...
					break;
				default: G("Unsupporting sharing policy");
			}
			return E;
		}
		function dg(g, B) {
		...
		function Fg(g, B) {
			switch (B) {
				...
				default: throw new TypeError("Unknown float type: " + g);
			}
		}
		function Ng(g, B, E) {
			switch (B) {
				case 0: return E ? function(C) {
					return Y[C];
				} : function(C) {
					return U[C];
				};
				case 1: return E ? function(C) {
					return v[C >> 1];
				} : function(C) {
					return _[C >> 1];
				};
				case 2: return E ? function(C) {
					return x[C >> 2];
				} : function(C) {
					return H[C >> 2];
				};
				default: throw new TypeError("Unknown integer type: " + g);
			}
		}
		function ug(g, B) {
		...
		NI = KI, Q.getInheritedInstanceCount = function() {
			...
			var C = cg(this.N, E);
			if (C !== void 0) return C.M.count.value === 0 ? (C.M.O = E, C.M.T = g, C.clone()) : (C = C.clone(), this.ha(g), C);
			if (C = this.N.pa(E), C = UI[C], !C) return B.call(this);
			C = this.ca ? C.la : C.pointerType;
			var t = kI(E, this.N, C.N);
			return t === null ? B.call(this) : this.da ? xA(C.N.X, {
				P: C,
				O: t,
				U: this,
				T: g
		...
		var Yg = typeof atob == "function" ? atob : function(g) {
			...
			l: function(g, B, E, C) {
				DA("Assertion failed: " + (g ? u(U, g) : "") + ", at: " + [
					B ? B ? u(U, B) : "" : "unknown filename",
					E,
					C ? C ? u(U, C) : "" : "unknown function"
				]);
			},
			q: function(g, B, E) {
			...
			j: function(g) {
				...
				EA([g], e, (s) => {
					...
					return t.forEach((w, h) => {
						...
						a[w.oa] = {
							read: (T) => y.fromWireType(d(N, T)),
							write: (T, HA) => {
								var BA = [];
								S(O, T, L.toWireType(BA, HA)), QI(BA);
							}
						};
					}), [{
						name: B.name,
			...
			e: function(g, B, E, C, t) {
				...
				E = B.includes("unsigned") ? function(a, w) {
					...
					toWireType: E,
					argPackAdvance: 8,
					readValueFromPointer: Ng(B, t, C !== 0),
					V: null
				});
			},
			b: function(g, B, E) {
			...
			i: function(g, B, E) {
				if (E = p(E), B === 2) var C = ug, t = Sg, e = Mg, s = () => _, a = 1;
			...
			m: function(g, B) {
				...
				return t = Jg((s, a, w, h) => {
					...
					for (s = s[a].apply(s, e), d = 0; d < g - 1; ++d) E[d + 1].ma && E[d + 1].ma(e[d]);
...
function Zg(A) {
	function I(i, o, D) {
		const r = i[o];
		i[o] = function() {
			for (var c = arguments.length, l = new Array(c), R = 0; R < c; R++) l[R] = arguments[R];
	...
	for (const i of [
		...
		I(A.Node.prototype, i, function(D) {
			for (var r = arguments.length, c = new Array(r > 1 ? r - 1 : 0), l = 1; l < r; l++) c[l - 1] = arguments[l];
			const R = c.pop();
			let F, u;
			if (R === "auto") F = z.Auto, u = void 0;
			else if (typeof R == "object") F = R.unit, u = R.valueOf();
			else if (F = typeof R == "string" && R.endsWith("%") ? z.Percent : z.Point, u = parseFloat(R), R !== void 0 && !Number.isNaN(R) && Number.isNaN(u)) throw new Error(`Invalid value ${R} for ${i}`);
	...
	function Q(i) {
		return A.MeasureCallback.implement({ measure: function() {
			const { width: o, height: D } = i(...arguments);
			return {
				width: o ?? NaN,
				height: D ?? NaN
			};
	...
	function n(i) {
		return A.DirtiedCallback.implement({ dirtied: i });
	}
...
function ng(A, I, Q) {
	...
	switch (i) {
		...
		case "right":
			...
			break;
		default: {
			const c = r.y === void 0 ? "y" : "x";
			r[c] = ZI(i, D, c === "y" ? "height" : "width", I, Q);
		}
	}
	return r;
}
...
function jg(A, I, Q) {
	...
	if (c === "keyword" || R === "keyword") throw new Error("Invalid objectPosition value: second and fourth values must be numbers or percentages");
	if (r !== "keyword" || l !== "keyword") throw new Error("Invalid objectPosition value: first and third values must be keywords");
...
function RI(A, I, Q) {
	...
	switch (n.length) {
		case 1: return _g(n, I, Q);
		case 2: return ng(n, I, Q);
		case 4: return jg(n, I, Q);
		default: throw new Error("Invalid objectPosition value: must have 1, 2, or 4 values");
	}
}
var DI = {
	width: 0,
...
function $g(A, I = 0, Q = {}) {
	...
	function iA(...M) {
		...
		if (n = M, i = this, c = m, K) {
			if (r === void 0) return _(c);
			if (F) return r = U(X, I), Y(c);
		}
...
var IB = Object.defineProperty, gB = (A, I, Q) => I in A ? IB(A, I, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: Q
}) : A[I] = Q, eA = (A, I, Q) => gB(A, typeof I != "symbol" ? I + "" : I, Q);
var sg = class {
	constructor() {
	...
	*/
	async enableDebug(I = !this._debugEnabled) {
		if (this._debugEnabled = I, !this._debugRenderer) this._debugRenderer = new (await (Promise.resolve().then(() => JB))).DebugRenderer();
	...
	*/
	_updateSize(I) {
		...
		for (let n = 0; n < I.children.length; n++) this._updateSize(I.children[n]);
	}
	/**
	* Updates the layout of the container and its children
	* @param container - The container to update the layout for
	...
	updateLayout(I) {
		...
		if (I.visible) {
			if (D) {
				...
				if (!((n = I.parent) != null && n._layout) && !l && D._isDirty && (D._isDirty = !1, r.calculateLayout(c.width, c.height, r.getDirection() ?? sA.LTR)), r.hasNewLayout() || D._forceUpdate) {
			...
			for (let r = 0; r < I.children.length; r++) this.updateLayout(I.children[r]);
		}
	}
	/**
	* @ignore
...
function DB(A, I = {}) {
	for (const [Q, n] of Object.entries(I)) try {
		const i = BB[Q];
		i && i(A, n);
	} catch {}
	if (I.width !== void 0) {
...
function hB(A, I) {
	...
	n = {
		...
		...A.target instanceof ViewContainer || n.isLeaf || RA.defaultStyle.shared.isLeaf ? RA.defaultStyle.leaf : RA.defaultStyle.container,
		...n
	};
...
function cB(A, I) {
	var Q;
	let n = I.layout, i;
	if (!n && I.isOverflowContainer && (i = I, n = (Q = i.parent) == null ? void 0 : Q.layout, I = i.parent), !n) return !1;
	const o = A.yoga.getParent();
	o && o.removeChild(A.yoga);
	const D = wB(A, I, i);
	return D === -1 ? !1 : (n.yoga.getChildCount(), n.yoga.insertChild(A.yoga, D), !0);
}
function wB(A, I, Q) {
	const n = A.target;
	let i = 0;
	if (Q) {
		for (const o of I.children) {
			if (o === Q) {
				for (const D of Q.children) if (!(!D.layout || !D.visible)) {
					if (D === n) return i;
					i++;
				}
				return -1;
	...
	for (const o of I.children) if (!(!o.layout || !o.visible)) {
		if (o === n) return i;
		i++;
	}
	return -1;
...
var lB = Object.defineProperty, RB = (A, I, Q) => I in A ? lB(A, I, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: Q
}) : A[I] = Q, b = (A, I, Q) => RB(A, typeof I != "symbol" ? I + "" : I, Q);
var RA = class {
	...
	*/
	getRoot(I) {
		var Q, n;
		let i = I || this.target;
		for (; (Q = i.parent) != null && Q._layout || (n = i.parent) != null && n.isOverflowContainer;) i = i.parent, i.isOverflowContainer && (i = i.parent);
		return i;
	}
	/**
	* @ignore
...
function Dg(A, I, Q, n) {
	const i = A.getLocalBounds();
	let { offsetScaleX: D, offsetScaleY: r } = ag(A.layout.style.objectFit || Q, I, i);
	const c = {
		width: i.width * D,
		height: i.height * r
	};
	let { x: l, y: R } = RI(A.layout.style.objectPosition, I, c);
	n ? (l += i.width * D * n._x, R += i.height * r * n._y) : (l -= i.minX * D, R -= i.minY * r);
	const F = A.layout.style.applySizeDirectly;
	return (F === !0 || F == null && (A instanceof TilingSprite || A instanceof NineSliceSprite)) && (A.width = i.width * D, A.height = i.height * r, D = 1, r = 1), {
		x: I.left,
		y: I.top,
		offsetX: l,
		offsetY: R,
...
var hI = Object.getOwnPropertyDescriptor(Container.prototype, "visible");
extensions.mixin(Container, {
	...
	set layout(A) {
		if (A = A === !0 ? {} : A, !A) {
			this._layout && (this._layout.destroy(), this._layout = null, this.updateLocalTransform = Container.prototype.updateLocalTransform, Object.defineProperty(Container.prototype, "visible", hI));
			return;
		}
		if (!this._layout) {
			this._layout = new RA({ target: this }), Object.defineProperty(Container.prototype, "visible", {
				...hI,
				set(I) {
					hI.set.call(this, I), this.layout && (I && this.parent ? this.layout._onChildAdded(this.parent) : this.layout._onChildRemoved());
				}
			});
			for (const I of this.children) I.layout && I.visible && (I.layout._onChildRemoved(), I.layout._onChildAdded(this));
	...
	updateLocalTransformWithLayout() {
		...
		const { x: Q, y: n, offsetX: i, offsetY: o, scaleX: D, scaleY: r, originX: c, originY: l } = this._layout._computedPixiLayout, R = this.localTransform, { rotation: F, skew: u, scale: J, position: Y } = this, U = F + u._y, v = F - u._x, _ = Math.cos(U) * J._x, x = Math.sin(U) * J._x, H = -Math.sin(v) * J._y, X = Math.cos(v) * J._y, tA = Y._x + Q - c * _ - l * H, aA = Y._y + n - c * x - l * X;
		R.a = _ * D, R.b = x * D, R.c = H * r, R.d = X * r, R.tx = tA + (i * _ + o * H) + c, R.ty = aA + (i * x + o * X) + l;
	},
	computeLayoutData(A) {
		const { isLeaf: Q } = this._layout._styles.custom;
...
var Eg = new Point(0, 0);
extensions.mixin(AbstractText, { computeLayoutData(A) {
	const I = this._style;
	Eg.copyFrom(this.scale), this.scale = 1, I.wordWrap && (I.wordWrapWidth = A.width);
	let Q = this.getLocalBounds();
	const { offsetScaleX: i, offsetScaleY: o } = ag(this.layout.style.objectFit || "scale-down", A, Q);
	I.wordWrap && (I.wordWrapWidth = A.width / Math.min(1, Math.max(i, o))), Q = this.getLocalBounds();
	const D = {
		width: Q.width * i,
		height: Q.height * o
	};
	let { x: r, y: c } = RI(this.layout.style.objectPosition, A, D);
...
var cI = Object.getOwnPropertyDescriptor(AbstractText.prototype, "text");
...
extensions.mixin(ViewContainer, { computeLayoutData(A) {
...
function FB(A, I) {
	const { width: Q, height: n } = A.computedLayout, i = wI(A, "margin"), o = wI(A, "border"), D = wI(A, "padding"), r = I.get("margin");
...
function NB(A, I) {
	var Q;
	const n = I.get("flex"), i = I.get("padding");
	n.outer.copyFrom(i.inner);
	const o = new Bounds(), D = A.yoga.getChildCount();
	for (let c = 0; c < D; c++) {
		const R = A.yoga.getChild(c).getComputedLayout();
		o.addRect(new Rectangle(R.left, R.top, R.width, R.height));
	}
	const r = A.yoga.getFlexDirection();
	r === j.Column || r === j.ColumnReverse ? (o.width = n.outer.width, o.x = n.outer.x) : (o.height = n.outer.height, o.y = n.outer.y), (Q = n.inner) == null || Q.copyFrom(o.rectangle), I.get("content").outer.copyFrom(o.rectangle);
}
var uB = Object.defineProperty, SB = (A, I, Q) => I in A ? uB(A, I, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: Q
}) : A[I] = Q, Cg = (A, I, Q) => SB(A, typeof I != "symbol" ? I + "" : I, Q);
function MB(A, I, Q) {
	return `rgb(${Math.round(A[0] + (I[0] - A[0]) * Q)},${Math.round(A[1] + (I[1] - A[1]) * Q)},${Math.round(A[2] + (I[2] - A[2]) * Q)})`;
}
var kB = class extends Container {
	constructor() {
		...
		}), this.heatGraphics = new Graphics(), this.addChild(this.heatGraphics);
	}
	/**
	...
	*/
	init(I) {
		...
		I.heatOnly || Object.entries(I).forEach(([r, c]) => {
			...
			if (!(!l || !c.draw)) if (c.inner) this.drawCutBox(l, c.outer, c.inner, c.color, n);
			else {
				const { x: R, y: F, width: u, height: J } = c.outer;
				l.rect(R, F, u, Math.max(J, 1)), l.fill({
					color: c.color,
					alpha: n
				});
			}
		...
		if (o > 0 && D) {
			const c = Math.min(o / 20, 1), l = I[V.Margin], u = MB([
				255,
				255,
				0
			], [
			...
			this.heatGraphics.rect(l.outer.x, l.outer.y, l.outer.width, l.outer.height), this.heatGraphics.fill({
				color: u,
				alpha: Math.min(.3, c)
	...
	*/
	drawCutBox(I, Q, n, i, o) {
		...
		I.rect(D, r, c, l), I.fill({
			color: i,
			alpha: o
		}), I.rect(R, F, u, J), I.cut();
	}
};
var UB = Object.defineProperty, HB = (A, I, Q) => I in A ? UB(A, I, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: Q
}) : A[I] = Q, TA = (A, I, Q) => HB(A, typeof I != "symbol" ? I + "" : I, Q);
var LB = class {
	constructor() {
		TA(this, "holder", new Container()), TA(this, "regions", /* @__PURE__ */ new Map()), TA(this, "colors", {
			[V.Margin]: "#B68655",
			[V.Padding]: "#BAC57F",
			[V.Border]: "#E7C583",
			[V.Content]: "#89B1BE",
			[V.Flex]: "#6E28D9"
		}), TA(this, "alpha", .75), Object.values(V).forEach((I) => {
			this.regions.set(I, {
				outer: new Rectangle(),
				inner: new Rectangle()
			});
	...
	*/
	render(I) {
		FB(I, this.regions);
		const Q = Object.values(V).reduce((r, c) => {
		...
		}, {}), { left: n, top: i } = I.computedLayout, o = I.target.getGlobalPosition(), D = BigPool.get(kB, {
			...Q,
			target: {
				x: o.x + n,
				y: o.y + i
...
var JB = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	DebugRenderer: LB
}, Symbol.toStringTag, { value: "Module" }));
extensions.add(sg);
//#endregion
export { LB as DebugRenderer, RA as Layout, sg as LayoutSystem, DB as applyStyle, hB as formatStyles, VA as getNumberFromStyle, rg as getPixiSize, nA as getTypeFromStyle, og as getYoga, zg as getYogaConfig, TI as nearlyEqual, cB as onChildAdded, yB as onChildRemoved, qg as setYoga, Vg as setYogaConfig };

//# sourceMappingURL=index-DaGekQUW-d3axY7dC.js.map
