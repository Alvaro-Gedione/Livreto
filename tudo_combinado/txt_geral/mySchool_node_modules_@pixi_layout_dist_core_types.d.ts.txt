import { YogaStyles } from './style/yogaStyles';
...
type TwoValuePosition = `${NumberValue} ${NumberValue}` | `${PositionKeyword} ${PositionKeyword}` | `${PositionKeyword} ${NumberValue}` | `${NumberValue} ${PositionKeyword}`;
