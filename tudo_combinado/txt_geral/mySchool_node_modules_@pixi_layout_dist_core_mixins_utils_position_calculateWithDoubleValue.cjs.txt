...
function calculateNonKeywordPosition(value, valueType, dimension, computedLayout, visualBounds) {
  ...
  return getNumberFromStyle.getNumberFromStyle(value) * multiple;
}
...
exports.calculateWithDoubleValue = calculateWithDoubleValue;
//# sourceMappingURL=calculateWithDoubleValue.cjs.map
