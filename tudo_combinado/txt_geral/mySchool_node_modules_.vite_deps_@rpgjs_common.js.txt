//#region node_modules/@rpgjs/common/dist/index.js
/******************************************************************************
...
__name(isClass$1, "isClass");
var isObject$1 = /* @__PURE__ */ __name((item) => item && typeof item === "object" && !Array.isArray(item) && item !== null, "isObject");
...
function createStatesSnapshot(instance) {
	...
	if (instance?.$snapshot) for (const key of instance.$snapshot.keys()) {
		...
		let value = signal();
		if (isObject$1(value) || Array.isArray(value)) continue;
...
var createSyncClass = /* @__PURE__ */ __name((currentClass, parentKey = null, parentClass = null, path = "") => {
	...
	if (currentClass.$snapshot) for (const key of currentClass.$snapshot.keys()) {
		...
		if (isObject$1(signalValue) || Array.isArray(signalValue)) signalValue = { ...signalValue };
...
var type = /* @__PURE__ */ __name((_signal, path, options = {}, currentInstance) => {
	...
	const handleObjectSubject = /* @__PURE__ */ __name((value, propPath) => {
		...
		else if (value.type === "update" && (isObject$1(value.value) || Array.isArray(value.value))) createSyncClass(value.value, value.key, currentInstance, newPath);
	...
	const handleArraySubject = /* @__PURE__ */ __name((value, propPath) => {
		...
		else if (value.type === "update" && (isObject$1(firstItem) || Array.isArray(firstItem))) createSyncClass(firstItem, value.key, currentInstance, newPath);
	...
	const savePath = /* @__PURE__ */ __name((propPath, value) => {
		...
		if (persist2 && currentInstance.$path !== void 0) currentInstance.$valuesChanges.setPersist(transformedValue == DELETE_TOKEN ? propPath : currentInstance.$path, transformedValue);
	}, "savePath");
...
function loadValue(rootInstance, parts, value) {
	...
	for (let i = 0; i < parts.length; i++) {
		const part = parts[i];
		if (i === parts.length - 1) if (value == DELETE_TOKEN) {
...
__decorateClass$2([id()], Item.prototype, "id");
__decorateClass$2([sync()], Item.prototype, "name");
__decorateClass$2([sync()], Item.prototype, "icon");
__decorateClass$2([sync()], Item.prototype, "quantity");
...
__decorateClass$1([id()], Skill.prototype, "id");
__decorateClass$1([sync()], Skill.prototype, "name");
__decorateClass$1([sync()], Skill.prototype, "spCost");
__decorateClass$1([sync()], Skill.prototype, "icon");
...
__decorateClass([id()], RpgCommonPlayer.prototype, "id");
__decorateClass([sync()], RpgCommonPlayer.prototype, "name");
__decorateClass([sync()], RpgCommonPlayer.prototype, "type");
__decorateClass([sync()], RpgCommonPlayer.prototype, "x");
__decorateClass([sync()], RpgCommonPlayer.prototype, "y");
__decorateClass([sync()], RpgCommonPlayer.prototype, "z");
__decorateClass([sync()], RpgCommonPlayer.prototype, "tint");
__decorateClass([sync()], RpgCommonPlayer.prototype, "direction");
__decorateClass([sync()], RpgCommonPlayer.prototype, "speed");
__decorateClass([sync()], RpgCommonPlayer.prototype, "graphics");
__decorateClass([sync({ persist: false })], RpgCommonPlayer.prototype, "canMove");
__decorateClass([sync()], RpgCommonPlayer.prototype, "hitbox");
__decorateClass([sync()], RpgCommonPlayer.prototype, "_gold");
__decorateClass([sync()], RpgCommonPlayer.prototype, "animationName");
__decorateClass([sync()], RpgCommonPlayer.prototype, "hpSignal");
__decorateClass([sync()], RpgCommonPlayer.prototype, "spSignal");
__decorateClass([sync()], RpgCommonPlayer.prototype, "_exp");
__decorateClass([sync()], RpgCommonPlayer.prototype, "_level");
__decorateClass([sync()], RpgCommonPlayer.prototype, "_class");
__decorateClass([sync(Item)], RpgCommonPlayer.prototype, "items");
__decorateClass([sync()], RpgCommonPlayer.prototype, "equipments");
__decorateClass([sync()], RpgCommonPlayer.prototype, "states");
__decorateClass([sync(Skill)], RpgCommonPlayer.prototype, "skills");
__decorateClass([sync()], RpgCommonPlayer.prototype, "_effects");
__decorateClass([sync()], RpgCommonPlayer.prototype, "_through");
__decorateClass([sync()], RpgCommonPlayer.prototype, "_throughOtherPlayer");
__decorateClass([sync()], RpgCommonPlayer.prototype, "_throughEvent");
__decorateClass([sync()], RpgCommonPlayer.prototype, "_frequency");
__decorateClass([sync()], RpgCommonPlayer.prototype, "_frames");
__decorateClass([sync()], RpgCommonPlayer.prototype, "componentsTop");
__decorateClass([sync()], RpgCommonPlayer.prototype, "componentsBottom");
__decorateClass([sync()], RpgCommonPlayer.prototype, "componentsCenter");
__decorateClass([sync()], RpgCommonPlayer.prototype, "componentsLeft");
__decorateClass([sync()], RpgCommonPlayer.prototype, "componentsRight");
__decorateClass([connected()], RpgCommonPlayer.prototype, "isConnected");
var RpgShape = class {
	/**
...
var _Vector2 = class _Vector2 {
	...
	*/
	rotate(angle) {
		...
		return new _Vector2(this.x * cos - this.y * sin, this.x * sin + this.y * cos);
	}
	/**
	...
	*/
	lerp(other, t) {
		return new _Vector2(this.x + (other.x - this.x) * t, this.y + (other.y - this.y) * t);
	}
	/**
...
var Matrix2 = class Matrix2 {
	...
	*/
	multiply(other) {
		return new Matrix2(this.m00 * other.m00 + this.m01 * other.m10, this.m00 * other.m01 + this.m01 * other.m11, this.m10 * other.m00 + this.m11 * other.m10, this.m10 * other.m01 + this.m11 * other.m11);
	}
	/**
	...
	*/
	inverse() {
		...
		if (Math.abs(det) < 1e-10) throw new Error("Matrix is singular and cannot be inverted");
		const invDet = 1 / det;
...
var EPSILON$1 = 1e-5;
function approximatelyEqual(a, b, epsilon = EPSILON$1) {
...
function projectPointOnLineSegment(point, lineStart, lineEnd) {
	...
	if (lineLengthSq < 1e-5) return lineStart.clone();
	const t = clamp(pointVec.dot(line) / lineLengthSq, 0, 1);
	return lineStart.add(line.mul(t));
}
function closestPointOnAABB(point, aabb) {
	return new Vector2(clamp(point.x, aabb.minX, aabb.maxX), clamp(point.y, aabb.minY, aabb.maxY));
}
...
function generateDeterministicUUID(seed) {
	...
	hash = hash & hash;
	return `00000000-0000-4000-8000-${Math.abs(hash).toString(16).padStart(8, "0").padStart(12, "0")}`;
}
...
var DistanceConstraint = class {
	...
	*/
	constructor(entityA, entityB, targetDistance, stiffness = .9) {
		this.entityA = entityA;
		this.entityB = entityB;
	...
	*/
	update(_deltaTime) {
		...
		if (!this.entityA.isStatic()) this.entityA.position.addInPlace(correctionA);
		if (!this.entityB.isStatic()) this.entityB.position.addInPlace(correctionB);
	}
	/**
...
var AnchorConstraint = class {
	...
	*/
	constructor(entity, anchorPoint, stiffness = .9) {
		this.entity = entity;
	...
	*/
	update(_deltaTime) {
		if (this.entity.isStatic()) return;
...
var Quadtree = class {
	...
	insertItem(node, item, depth) {
		...
		if (child) this.insertItem(child, item, depth + 1);
		else node.items.push(item);
	}
	queryBounds(node, bounds, out) {
		if (!node.bounds.intersects(bounds)) return;
		for (const it of node.items) if (it.bounds.intersects(bounds)) out.add(it.entity);
		if (node.children) for (const c of node.children) this.queryBounds(c, bounds, out);
	}
	subdivide(node) {
		const b = node.bounds;
		const midX = (b.minX + b.maxX) * .5;
		const midY = (b.minY + b.maxY) * .5;
		node.children = [
	...
	findChild(node, bounds) {
		...
		for (const c of node.children) if (containsAABB(c.bounds, bounds)) return c;
		return null;
	}
};
...
var BVH = class {
	...
	rebuild() {
		this.root = buildBVH(Array.from(this.entities.values()));
	}
};
function buildBVH(leaves) {
	...
	const axis = bounds.maxX - bounds.minX >= bounds.maxY - bounds.minY ? 0 : 1;
	leaves.sort((a, b) => {
		if (!a || !b) return 0;
...
function centerOf(b, axis) {
	return axis === 0 ? (b.minX + b.maxX) * .5 : (b.minY + b.maxY) * .5;
}
...
function migrateEntities(migrations, handler) {
	for (const migration of migrations) migrateEntity(migration.entity, migration.fromRegion, migration.toRegion, handler);
}
...
var MovementManager$1 = class MovementManager {
...
var CompositeMovement = class {
	...
	*/
	...
	update(body, dt) {
		...
		if (this.mode === "parallel") this.updateParallel(body, dt);
		else this.updateSequence(body, dt);
	}
	isFinished() {
		if (this.mode === "parallel") return this.strategies.length === 0;
	...
	remove(strategy) {
		...
		if (this.currentIndex >= this.strategies.length) this.currentIndex = Math.max(0, this.strategies.length - 1);
		return true;
	}
	reset() {
		this.currentIndex = 0;
	...
	updateParallel(body, dt) {
		...
		for (let i = this.strategies.length - 1; i >= 0; i -= 1) {
			...
			strategy.update(body, dt);
			if (beforeX !== body.velocity.x || beforeY !== body.velocity.y) changes += 1;
			if (strategy.isFinished?.()) {
				this.strategies.splice(i, 1);
				strategy.onFinished?.();
			}
		}
		if (changes > 1) body.setVelocity({
			x: (body.velocity.x + originalVelocity.x) / 2,
			y: (body.velocity.y + originalVelocity.y) / 2
		});
	}
	updateSequence(body, dt) {
		if (this.currentIndex >= this.strategies.length) return;
...
var IceMovement = class {
	...
	*/
	constructor(direction, maxSpeed = 4, acceleration = .2, friction = .08, duration) {
	...
	*/
	...
	update(body, dt) {
		...
		if (this.elapsed <= this.duration) {
			...
			else this.currentSpeed *= Math.pow(decay, dt);
	...
	*/
	...
	update(body, _dt) {
		...
		if (!arrived) for (const other of neighbors) {
			if (other === entity || other === target || other.isStatic()) continue;
			const diff = new Vector2(entity.position.x - other.position.x, entity.position.y - other.position.y);
...
var PredictionController = class {
	...
	applyServerAck(ack) {
		if (typeof ack.frame !== "number") {
			...
			if (ack.state) result2.state = ack.state;
			return result2;
		}
...
var RpgCommonMap = class {
	...
	*/
	...
	loadPhysic() {
		...
		for (let staticHitbox of hitboxes) if ("x" in staticHitbox) this.addStaticHitbox(staticHitbox.id ?? generateShortUUID(), staticHitbox.x, staticHitbox.y, staticHitbox.width, staticHitbox.height);
		else if ("points" in staticHitbox) this.addStaticHitbox(staticHitbox.id ?? generateShortUUID(), staticHitbox.points);
		...
		this.eventsSubscription = this.events.observable.subscribe(({ value: event, type, key }) => {
			if (type === "add") {
				...
				this.createCharacterHitbox(_event, "npc", { mass: 100 });
			}
		});
	...
	addCharacter(options) {
		...
		entity.onMovementChange(({ isMoving, intensity }) => {
			...
			if (isMoving && intensity > LOW_INTENSITY_THRESHOLD) {
				if (hasSetAnimation) owner2.setGraphicAnimation("walk");
				else if (ownerHasAnimationName) animationNameSignal.set("walk");
			} else if (!isMoving) {
				if (hasSetAnimation) owner2.setGraphicAnimation("stand");
		...
		entity.onPositionChange(({ x, y }) => {
			...
			if (changed) currentOwner.applyFrames?.();
		});
	...
	getAdjacentMaps(map, search) {
		...
		if (typeof search === "number") {
			...
			return maps.filter((m) => {
				...
				switch (search) {
					case 0: return verticallyOverlapsOrTouches && m.worldY + m.heightPx - marginTopDown === src.worldY;
					case 1: return verticallyOverlapsOrTouches && m.worldY + marginTopDown === src.worldY + src.heightPx;
					case 2: return horizontallyOverlapsOrTouches && m.worldX + m.widthPx - marginLeftRight === src.worldX;
					case 3: return horizontallyOverlapsOrTouches && m.worldX + marginLeftRight === src.worldX + src.widthPx;
...
function createModule(tokenName, providers) {
	return providers.map((provider) => {
		const results2 = [];
		if (!provider) return [];
		if ("server" in provider) results2.push({
		...
		if ("client" in provider) results2.push({
		...
		if (!("server" in provider) && !("client" in provider)) results2.push(provider);
		return results2;
	}).flat().flat();
}
...
var UpdateMapToken = "UpdateMapToken";
var UpdateMapService = class {
	constructor(context) {
		this.context = context;
	}
};
function delay(cb, ms = 50) {
	setTimeout(cb, ms);
}
...
function sharedArrayBuffer() {
	let buffer;
	if (typeof SharedArrayBuffer != "undefined") buffer = SharedArrayBuffer;
...
function hexaToNumber(hexa) {
	...
	let alpha = 1;
	if (val.length === 3) val = val.split("").map((v) => v + v).join("");
	if (val.length === 8) {
...
function set(obj, path, value, onlyPlainObject = false) {
	...
	path.slice(0, -1).reduce((a, c, i) => Object(a[c]) === a[c] ? a[c] : a[c] = Math.abs(path[i + 1]) >> 0 === +path[i + 1] ? onlyPlainObject ? {} : [] : {}, obj)[path[path.length - 1]] = value;
	return obj;
}
...
function mergeObjectWithMethods(target, source) {
	const propertyNames = Object.getOwnPropertyNames(source);
	for (const name of propertyNames) if (name !== "constructor") {
		const descriptor = Object.getOwnPropertyDescriptor(source, name);
		if (descriptor) Object.defineProperty(target, name, descriptor);
	}
	const sourceProto = Object.getPrototypeOf(source);
	if (sourceProto && sourceProto !== Object.prototype) Object.setPrototypeOf(target, sourceProto);
	return target;
}
...
function getSharedPerlinNoise(seed) {
	if (!sharedInstance) sharedInstance = new PerlinNoise2D(seed);
