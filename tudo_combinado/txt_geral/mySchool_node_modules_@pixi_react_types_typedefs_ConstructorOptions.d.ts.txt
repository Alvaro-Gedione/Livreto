 ...
 */
export type ConstructorOptions<T extends new (...args: any[]) => any> = Extract<ConstructorOverrides, {
    0: T;
}> extends [T, infer R] ? unknown extends R ? NonNullable<Exclude<ConstructorParameters<T>[0], ConstructorOptionExcludes>> : R : unknown;
export {};
